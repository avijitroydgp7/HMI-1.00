...
class Ribbon(QToolBar):
    ...
    def _populate_figure_tab(self):
        tb = self.figure_tab.toolbar
        self.rect_action = QAction(IconManager.create_icon('fa5s.square'), "Rectangle", self)
        tb.addAction(self.rect_action)
        self.circle_action = QAction(IconManager.create_icon('fa5s.circle'), "Circle", self)
        tb.addAction(self.circle_action)
        self.polygon_action = QAction(IconManager.create_icon('fa5s.draw-polygon'), "Polygon", self)
        tb.addAction(self.polygon_action)
        self.text_action = QAction(IconManager.create_icon('fa5s.font'), "Text", self)
